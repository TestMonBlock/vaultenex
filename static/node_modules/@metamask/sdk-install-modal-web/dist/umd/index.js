! function(e, t) {
    ...
    var u = function(e) {
            ...
            return t.useEffect((function() {
                k.current && new(require("qr-code-styling"))({
                    width: 270,
                    height: 270,
                    type: "svg",
                    data: e.link,
                ...
                style: a.closeButtonContainer
            }, t.createElement("div", {
                style: a.right
            }, t.createElement("span", {
                style: a.closeButton,
                onClick: e.onClose
            }, t.createElement(C, null)))), t.createElement("div", {
                style: a.logoContainer
            }, t.createElement(p, null)), t.createElement("div", null, t.createElement("div", {
                style: a.tabcontainer
            }, t.createElement("div", {
                style: a.flexContainer
            }, t.createElement("div", {
                onClick: function() {
                    return u(1)
                },
                style: o(o(o({}, a.tab), 1 === i ? a.tabactive : {}), a.flexItem)
            }, h("DESKTOP")), t.createElement("div", {
                onClick: function() {
                    return u(2)
                },
                style: o(o(o({}, a.tab), 2 === i ? a.tabactive : {}), a.flexItem)
            }, h("MOBILE")))), t.createElement("div", {
                style: {
                    display: 1 === i ? "none" : "block"
                }
            }, t.createElement("div", {
                style: a.flexContainer
            }, t.createElement("div", {
                ...
                style: a.connectMobileText
            }, h("SCAN_TO_CONNECT"), " ", t.createElement("br", null), t.createElement("span", {
                style: a.blue
            }, t.createElement("b", null, h("META_MASK_MOBILE_APP"))))))), t.createElement("div", {
                style: {
                    display: 2 === i ? "none" : "block"
                }
            }, t.createElement("div", {
                style: a.item
            }, t.createElement(s, {
                Icon: d,
                text: h("INSTALL_MODAL.TRUSTED_BY_USERS")
            })), t.createElement("div", {
                style: a.item
            }, t.createElement(s, {
                Icon: L,
                text: h("INSTALL_MODAL.LEADING_CRYPTO_WALLET")
            })), t.createElement("div", {
                style: a.item
            }, t.createElement(s, {
                Icon: E,
                text: h("INSTALL_MODAL.CONTROL_DIGITAL_INTERACTIONS")
            })), t.createElement("button", {
                style: a.button,
                onClick: e.metaMaskInstaller.startDesktopOnboarding
            }, t.createElement(c, null), t.createElement("span", {
                style: a.installExtensionText
            }, h("INSTALL_MODAL.INSTALL_META_MASK_EXTENSION"))))), t.createElement(m, {
                version: f
            })))
        },
        k = function(e) {
            var n, r = null === (n = e.displayOTP) || void 0 === n || n,
                i = e.sdkVersion,
                s = e.i18nInstance.t;
            return t.createElement(l, {
            ...
            }, s(r ? "PENDING_MODAL.OPEN_META_MASK_SELECT_CODE" : "PENDING_MODAL.OPEN_META_MASK_CONTINUE")), t.createElement("div", {
                id: "sdk-mm-otp-value",
                style: {
                    padding: 10,
                    fontSize: 32,
                ...
                style: o({}, a.notice)
            }, "* ", s("PENDING_MODAL.NUMBER_AFTER_OPEN_NOTICE"))), t.createElement("div", {
                style: {
                    marginTop: "20px"
                }
            }, t.createElement("button", {
                style: o(o(o({}, a.button), a.blue), {
                    marginTop: "5px",
                    color: "#0376C9",
                    borderColor: "#0376C9",
                    borderWidth: "1px",
            ...
            }, s("PENDING_MODAL.DISCONNECT")))), t.createElement(m, {
                version: i
            })))
        },
        f = function() {
        ...
        g = function(e) {
            ...
            return t.createElement(l, {
                ...
                style: o(o(o({}, a.tab), 1 === r ? a.tabactive : {}), a.flexItem)
            }, d("DESKTOP")), t.createElement("div", {
                onClick: function() {
                    return i(2)
                },
                style: o(o(o({}, a.tab), 2 === r ? a.tabactive : {}), a.flexItem)
            }, d("MOBILE")))), t.createElement("div", {
                style: {
                ...
                style: a.connectMobileText
            }, d("SCAN_TO_CONNECT"), t.createElement("br", null), t.createElement("span", {
                style: a.blue
            }, t.createElement("b", null, d("META_MASK_MOBILE_APP"))))))), t.createElement("div", {
                style: {
            ...
            }, t.createElement(h, null)), t.createElement("div", {
                style: a.extensionLabel
            }, d("SELECT_MODAL.CRYPTO_TAKE_CONTROL_TEXT")), t.createElement("button", {
                style: a.button,
                onClick: e.connectWithExtension
            }, t.createElement(f, null), t.createElement("span", {
                style: a.installExtensionText
            }, d("CONNECT_WITH_EXTENSION"))))), t.createElement(m, {
                version: s
            })))
        },
        M = function() {
            function e(e) {
                var t = e.debug,
                    n = e.sdkVersion,
                    o = this;
                this.debug = !1, this.updateOTPValue = function(e) {
                    o.debug && console.debug("ModalLoader: updateOTPValue", e);
                    setTimeout((function() {
                        var t;
                        o.debug && console.debug("ModalLoader: updateOTPValue: delayed otp update"), t = document.getElementById("sdk-mm-otp-value"), o.debug && console.debug("ModalLoader: updateOTPValue: otpNode", t), t && (t.textContent = e, t.style.display = "block")
                    }), 800)
                }, this.updateQRCode = function(e) {
                    o.debug && console.debug("ModalLoader: updateQRCode", e);
                    var t = document.getElementById("sdk-qrcode-container");
                    t && (t.innerHTML = "", new(require("qr-code-styling"))({
                        width: 270,
                        height: 270,
                        type: "svg",
                        data: e,
                ...
                }, this.debug = null != t && t, this.sdkVersion = n
            }
            return e.prototype.renderInstallModal = function(e) {
                this.debug && console.debug("ModalLoader: renderInstallModal", e), this.installContainer = e.parentElement, n.createRoot(e.parentElement).render(t.createElement(u, {
                    link: e.link,
                ...
                var r = this;
                this.debug && console.debug("ModalLoader: renderSelectModal", e), this.selectContainer = e.parentElement, n.createRoot(e.parentElement).render(t.createElement(g, {
                    link: e.link,
                    sdkVersion: this.sdkVersion,
                    onClose: e.onClose,
                ...
                this.debug && console.debug("ModalLoader: renderPendingModal", e), this.pendingContainer = e.parentElement, n.createRoot(e.parentElement).render(t.createElement(k, {
                    onClose: e.onClose,
                ...
                var e, t, n, r, o, i;
                null === (t = null === (e = this.pendingContainer) || void 0 === e ? void 0 : e.parentNode) || void 0 === t || t.removeChild(this.pendingContainer), this.pendingContainer = void 0, null === (r = null === (n = this.installContainer) || void 0 === n ? void 0 : n.parentNode) || void 0 === r || r.removeChild(this.installContainer), this.installContainer = void 0, null === (i = null === (o = this.selectContainer) || void 0 === o ? void 0 : o.parentNode) || void 0 === i || i.removeChild(this.selectContainer), this.selectContainer = void 0
            }, e
        }();
    e.ModalLoader = M
}));
