    ...
    [171], {
        32447: (e, t, s) => {
            ...
            const a = (0, o.BX)({
                ...
                i = {
                    ...
                    isAndroid: () => i.isMobile() && navigator.userAgent.toLowerCase().includes("android"),
                    isIos() {
                    ...
                    formatNativeUrl(e, t, s) {
                        ...
                        return "".concat(o, "wc?uri=").concat(a)
                    },
                    ...
                    setModalVersionInStorage() {
                        try {
                            typeof localStorage < "u" && localStorage.setItem(i.WCM_VERSION, "2.6.2")
                        } catch {
                    ...
                    getWalletRouterData() {
                        var e;
                        const t = null == (e = n.state.data) ? void 0 : e.Wallet;
                        if (!t) throw new Error('Missing "Wallet" view data');
                        return t
                    }
                },
                l = typeof location < "u" && (location.hostname.includes("localhost") || location.protocol.includes("https")),
                r = (0, o.BX)({
                    enabled: l,
                    userSessionId: "",
                    events: [],
                ...
                c = {
                    state: r,
                    subscribe: e => (0, o.B1)(r.events, (() => e((0, o.P9)(r.events[r.events.length - 1])))),
                    initialize() {
                        r.enabled && typeof(null == crypto ? void 0 : crypto.randomUUID) < "u" && (r.userSessionId = crypto.randomUUID())
                    },
                ...
                m = {
                    state: u,
                    subscribe: e => (0, o.B1)(u, (() => e(u))),
                    setConfig(e) {
                        var t, s;
                        c.initialize(), p.setChains(e.chains), p.setIsAuth(Boolean(e.enableAuthMode)), p.setIsCustomMobile(Boolean(null == (t = e.mobileWallets) ? void 0 : t.length)), p.setIsCustomDesktop(Boolean(null == (s = e.desktopWallets) ? void 0 : s.length)), i.setModalVersionInStorage(), Object.assign(u, e)
                    }
                };
            ...
            async function w(e, t) {
                const s = ((e, t) => {
                        for (var s in t || (t = {})) b.call(t, s) && I(e, s, t[s]);
                        if (h)
                            for (var s of h(t)) v.call(t, s) && I(e, s, t[s]);
                        return e
                    })({
                        sdkType: C,
                        sdkVersion: f
                    ...
                    o = new URL(e, y);
                return o.searchParams.append("projectId", m.state.projectId), Object.entries(s).forEach((e => {
                    let [t, s] = e;
            ...
            const W = {
                ...
                getWalletImageUrl: e => "".concat(y, "/w3m/v1/getWalletImage/").concat(e, "?projectId=").concat(m.state.projectId, "&sdkType=").concat(C, "&sdkVersion=").concat(f),
                getAssetImageUrl: e => "".concat(y, "/w3m/v1/getAssetImage/").concat(e, "?projectId=").concat(m.state.projectId, "&sdkType=").concat(C, "&sdkVersion=").concat(f)
            };
            ...
            const D = i.isMobile(),
                ...
                k = {
                    ...
                    async getRecomendedWallets() {
                        ...
                        if (i.isArray(e)) {
                            const t = {
                                ...
                                {
                                    listings: s
                                } = await W.getAllListings(t),
                                o = Object.values(s);
                            o.sort(((t, s) => e.indexOf(t.id) - e.indexOf(s.id))), M.recomendedWallets = o
                        } else {
                            const {
                                chains: e,
                                isAuth: s
                            } = p.state, o = null === e || void 0 === e ? void 0 : e.join(","), a = i.isArray(t), n = {
                                page: 1,
                                sdks: s ? "auth_v1" : void 0,
                                entries: i.RECOMMENDED_WALLET_AMOUNT,
                                chains: o,
                                version: 2,
                                excludedIds: a ? t.join(",") : void 0
                            }, {
                                listings: l
                            } = D ? await W.getMobileListings(n) : await W.getDesktopListings(n);
                    ...
                    async getWallets(e) {
                        const t = ((e, t) => {
                                for (var s in t || (t = {})) O.call(t, s) && U(e, s, t[s]);
                                if (E)
                        ...
                        if ("ALL" === o) return M.wallets;
                        a.length ? t.excludedIds = a.map((e => e.id)).join(",") : i.isArray(s) && (t.excludedIds = s.join(",")), i.isArray(o) && (t.excludedIds = [t.excludedIds, o].filter(Boolean).join(",")), p.state.isAuth && (t.sdks = "auth_v1");
                        const {
                            page: n,
                            search: l
                        } = e, {
                            listings: r,
                            total: c
                        } = D ? await W.getMobileListings(t) : await W.getDesktopListings(t), d = Object.values(r), u = l ? "search" : "wallets";
                        return M[u] = {
                            listings: [...M[u].listings, ...d],
                            total: c,
                            page: null !== n && void 0 !== n ? n : 1
                        }, {
                            listings: d,
                            total: c
                        }
                ...
                N = {
                    state: j,
                    subscribe: e => (0, o.B1)(j, (() => e(j))),
                    open: async e => new Promise((t => {
                        const {
                            isUiLoaded: s,
                            isDataLoaded: o
                        } = p.state;
                        if (i.removeWalletConnectDeepLink(), p.setWalletConnectUri(null === e || void 0 === e ? void 0 : e.uri), p.setChains(null === e || void 0 === e ? void 0 : e.chains), n.reset("ConnectWallet"), s && o) j.open = !0, t();
                        else {
                            const e = setInterval((() => {
                                const s = p.state;
            ...
            const x = (0, o.BX)({
                ...
                R = {
                    ...
                    setThemeConfig(e) {
                        ...
                        t && (x.themeMode = t), s && (x.themeVariables = ((e, t) => {
                            for (var s in t || (t = {})) B.call(t, s) && _(e, s, t[s]);
                            if (T)
                                for (var s of T(t)) P.call(t, s) && _(e, s, t[s]);
                            return e
                        })({}, s))
                    }
                },
                ...
                V = {
                    state: H,
                    subscribe: e => (0, o.B1)(H, (() => e(H))),
                    openToast(e, t) {
                        H.open = !0, H.message = e, H.variant = t
                    },
                    closeToast() {
                        H.open = !1
                    }
        ...
        67171: (e, t, s) => {
            ...
            class a {
                ...
                async initUi() {
                    if (typeof window < "u") {
                        await s.e(429).then(s.bind(s, 66429));
...
//# sourceMappingURL=171.816abf09.chunk.js.map